...
#video_recommendations, [class*=SuggestionsContainer__container], [class*=InternalTwoColumnLayoutColumn]+[class*=InternalTwoColumnLayoutColumn] section:not(:has([class*=laylist])),
